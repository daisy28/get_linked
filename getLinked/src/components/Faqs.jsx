      ...
      style={{
       ...
       transition: `all 1.3s cubic-bezier(0.17, 0.55, 0.55, 1) 300ms`}}
            >
              ...
              <p id="one" className={`${showThree ? `block` : `hidden`} text-left text-[10px] font-[400] text-[#ff26b9] leading-[22px]`}>Most hackathons allow both individuals and teams to participate. You can typically join a team at the hackathon itself, and organizers may help match participants who are looking for team members. Some hackathons also have specific team size size limits, so be sure to check the event&apos;s guidelines.</p>
              </div>
      ...
      style={{
       ...
       transition: `all 1.3s cubic-bezier(0.17, 0.55, 0.55, 1) 300ms`}}
            >
              ...
              <p id="one" className={`${showFour ? `block` : `hidden`} text-left text-[10px] font-[400] text-[#ff26b9] leading-[22px]`}>After the hackathon concludes, there will be the following: project presentation, networking sessions, continued project development and community engagement.</p>
              </div>
      ...
      style={{
       ...
       transition: `all 1.3s cubic-bezier(0.17, 0.55, 0.55, 1) 300ms`}}
            >
              ...
              <p id="one" className={`${showFive ? `block` : `hidden`} text-left text-[10px] font-[400] text-[#ff26b9] leading-[22px]`}>Yes, you can typically work on a project you started before the hackathon. However, it&apos;s important to check the specific rules and guidelines of the hackathon you&apos;re participating in, as some events may have restrictions or requirements regarding pre-existing projects.</p>
              </div>
